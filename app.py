...
def render_product_scraper_panel(body_key: str, current_body: str,
    ...
    with st.expander("🛒 商品情報を一覧から差し込む", expanded=False):
        ...
        st.caption("例: https://nishidaya.com/c/all-item/gr30　または　https://www.kubara.jp/item/search?sort=1&limit=40")
...
def main():
    ...
    st.title("📧 田舎主義ステップメール生成システム（拡張版）")
    st.markdown("---")
